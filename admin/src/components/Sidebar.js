            ...
            <ul className="md:flex-col md:min-w-full flex flex-col list-none md:mb-4">
              <li className="inline-flex">
                <Link
                  ...
                  to="/"
                >
                  <i className="fas fa-heart mr-2 text-blueGray-400 text-base"></i> Applications
                </Link>
              </li>
              <li className="inline-flex">
                <Link
                  ...
                  to="/"
                >
                  <i className="fas fa-paint-brush mr-2 text-blueGray-400 text-base"></i> Interviews
                </Link>
              </li>
              <li className="inline-flex">
                <Link
                  ...
                  to="/"
                >
                  <i className="fas fa-coins mr-2 text-blueGray-400 text-base"></i> Convos
                </Link>
              </li>
