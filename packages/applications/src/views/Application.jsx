...
const FORM_INPUT = {
  ...
  interests: { label: 'Interests', tip: 'At Kernel, we learn through conversation. What topics are you most passionate about? What fills your heart? Why?', tag: 'textarea' },
