...
const Intro = () => (
  <>
    ...
    <div className='columns-1 md:break-after-column'>
      <Paragraph>This application is the start of your Kernel Unprofile. It’s a way for us to find infinite players and for you to find lifelong friends.</Paragraph>
