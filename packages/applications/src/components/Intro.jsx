...
const Intro = () => (
  <>
    ...
    <div className='columns-1 md:break-after-column'>
      ...
      <Paragraph>What you write here will be visible to a group of current fellows who review applications. We value honesty, sincerity, simplicity and a diversity of skills and interests. <a className='text-blue-600 visited:text-purple-600' href='https://www.kernel.community/en/start/principled-people/' target='_blank' rel='noreferrer'>Our principles</a> are <strong>do no harm</strong> and <strong>play, infinitely</strong>. The purpose of this form is for us to get to know you. We will be most impressed by the quality of your intention, which we think is revealed through considerately crafted answers.</Paragraph>
